...
const trust = [
  { Icon: Stethoscope, label: "Pediatrician formulated" },
  { Icon: Ban, label: "No added sugar. Ever." },
  { Icon: Truck, label: "Ships in 24–48 hrs" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="font-display mt-5 text-[clamp(3rem,9vw,6.5rem)] leading-[0.95] text-[var(--forest)]">
            THE JAR
            <br />
            <span className="text-[var(--sage-deep)]">WALL</span>
          </h1>
          <Reveal delay={120}>
            <p className="mx-auto mt-5 max-w-xl text-base font-medium leading-relaxed text-[var(--forest-deep)]/90 sm:text-lg">
              Three stages of sprouted, sun-dried goodness — pick the age your
              little one is at today, or take the whole journey home in one
              box.
            </p>
          </Reveal>
        </div>
