...
const stats = [
  { to: 20, unit: "G", label: "of Protein", pos: "left-[6%] top-[22%]", delay: 300 },
  { to: 95, unit: "%", label: "less Sugar", pos: "left-[0%] top-[50%]", delay: 550 },
  { to: 85, unit: "MG", label: "of Caffeine", pos: "left-[18%] top-[78%]", delay: 800 },
];
  ...
  return (
    <>
      ...
      {stats.map((s, i) => (
        ...
        >
          <div
            className="flex h-[88px] w-[88px] animate-floaty flex-col items-center justify-center rounded-full bg-[var(--cloud)] text-center shadow-[0_14px_30px_rgba(20,56,15,0.16)] sm:h-[104px] sm:w-[104px]"
  ...
  return (
    <section className="relative overflow-hidden pt-24 sm:pt-28" id="top">
      ...
      <div className="pointer-events-none absolute inset-0">
        <Parallax
          speed={0.09}
          className="absolute -left-28 top-44 h-80 w-80 rounded-full bg-white/25 blur-3xl"
        />
        <Parallax
          speed={-0.07}
          className="absolute -right-20 bottom-16 h-96 w-96 rounded-full bg-[var(--cream)]/40 blur-3xl"
        />
      </div>
            ...
            <h2 className="text-center">
              <MaskedLines
                ...
                lines={[
                  <span
                    key="l1"
                    className="font-display block text-[clamp(3rem,8vw,6.5rem)] leading-[0.95] text-white drop-shadow-[0_2px_0_rgba(30,74,25,0.08)]"
                  >
                    MATCHA
                  </span>,
                  <span
                    key="l2"
                    className="font-display block text-[clamp(3rem,8vw,6.5rem)] leading-[0.95] text-[var(--forest)]"
                  >
                    MEETS
                  </span>,
                  <span
